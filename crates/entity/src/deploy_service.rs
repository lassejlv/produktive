...
pub struct Model {
    ...
    pub health_status_updated_at: Option<chrono::DateTime<chrono::FixedOffset>>,
    pub last_health_checked_at: Option<chrono::DateTime<chrono::FixedOffset>>,
    pub last_health_ok_at: Option<chrono::DateTime<chrono::FixedOffset>>,
