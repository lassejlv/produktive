...
const AuthedWidAdminDeployAccessRoute =
  AuthedWidAdminDeployAccessRouteImport.update({
    id: '/deploy-access',
    path: '/deploy-access',
    getParentRoute: () => AuthedWidAdminRoute,
  } as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authed/$wid/deployments/$serviceId': {
      ...
      path: '/$serviceId'
      fullPath: '/$wid/deployments/$serviceId'
      preLoaderRoute: typeof AuthedWidDeploymentsServiceIdRouteImport
...
const AuthedWidDeploymentsRouteWithChildren =
  AuthedWidDeploymentsRoute._addFileChildren(AuthedWidDeploymentsRouteChildren)
