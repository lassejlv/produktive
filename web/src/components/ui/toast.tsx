        ...
        {toasts.map((toast) => {
          ...
          return (
            ...
            >
              <Toast.Root
                className={cn(
                  "relative text-balance border-0 bg-popover not-dark:bg-clip-padding text-popover-foreground text-xs transition-[scale,opacity] data-ending-style:scale-98 data-starting-style:scale-98 data-ending-style:opacity-0 data-starting-style:opacity-0",
                  tooltipStyle
