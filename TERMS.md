# Produktive Terms of Service

Effective date: April 29, 2026

These Terms of Service ("Terms") govern access to and use of Produktive, a productivity workspace for issues, projects, team chat, AI-assisted workflows, file attachments, and workspace integrations (the "Service").
...
These Terms are a practical legal draft and should be reviewed by counsel before production use.

## 1. Who May Use Produktive

You must be at least 15 years old to use Produktive. If you are under the age of majority where you live, you represent that you have permission from a parent or legal guardian to use the Service.

If you use Produktive for an organization or workspace, you represent that you have authority to accept these Terms on behalf of that organization. You are responsible for ensuring that workspace members comply with these Terms.
...
Produktive provides tools to create and manage:

- workspaces and members;
- issues, comments, labels, projects, and activity history;
...
"Your Content" means content that you or your workspace members submit to Produktive, including issue titles and descriptions, comments, project data, chat prompts and responses, uploaded files, MCP server details, and other workspace data.

You keep ownership of Your Content. You grant us a limited license to host, store, copy, transmit, display, and process Your Content only as needed to operate, secure, support, and improve the Service, comply with law, and enforce these Terms.

You are responsible for Your Content and for having the rights and permissions needed to submit it. Do not upload or transmit content that is unlawful, harmful, infringing, confidential in a way you are not authorized to share, or otherwise violates these Terms.

## 5. AI Features

Produktive includes AI-assisted chat and workflow features. AI features may process prompts, chat history, tool-call context, workspace data, and uploaded-file references to generate responses or perform requested actions.

AI output may be inaccurate, incomplete, or unsuitable for your use case. You are responsible for reviewing AI output before relying on it. AI features are not legal, financial, medical, or other professional advice.

The current AI provider configuration is based on OpenCode Go. OpenCode Go documentation says its Go models are available through API endpoints and that providers follow a zero-retention policy and do not use user data for model training. That provider behavior may change, and provider terms may apply.

## 6. Integrations and Third-Party Services

Produktive uses and may integrate with third-party services, including:

- Unkey for deployment and API platform infrastructure;
...
Third-party services are not controlled by us. Their own terms, privacy policies, security practices, and availability may apply. You are responsible for reviewing and complying with any third-party terms that apply to your use, especially when you connect remote MCP servers or send data to external tools.

## 7. Acceptable Use

You agree not to:

- use Produktive for unlawful, harmful, deceptive, or abusive activity;
...
We do not warrant that the Service, AI output, third-party integrations, or connected tools will meet your requirements, be accurate, or be available without interruption.
...
To the maximum extent allowed by law, our total liability for all claims relating to the Service will not exceed the amounts paid by you to Produktive for the workspace giving rise to the claim during the 12 months before the event giving rise to liability, or EUR 100 if no amount was paid.
